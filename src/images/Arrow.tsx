...
export const Arrow: React.FC<ArrowProps> = ({ width, heigth }: ArrowProps) => {
  return (
    <svg
      ...
      width={`${width || '60'}`}
      height={`${heigth || '60'}`}
      viewBox={width && heigth ? `0 0 ${width} ${heigth}` : '0 0 60 60'}
      fill="none"
    >
      <rect
        x="0.692383"
